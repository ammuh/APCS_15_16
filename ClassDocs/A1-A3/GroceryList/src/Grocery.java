...
public class Grocery {
	...
	public static void main(String[] args) {
		...
		double item1 = (double)s.nextDouble();		
		System.out.print("Enter item#2: ");
		double item2 = (double)s.nextDouble();
		System.out.print("Enter item#3: ");
		double item3 = (double)s.nextDouble();
		System.out.print("Enter item#4: ");
		double item4 = (double)s.nextDouble();
		System.out.print("Enter item#5: ");
		double item5 = (double)s.nextDouble();
